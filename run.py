            ...
            try:
                with open(
                    ...
                    for gruppe_data in data.get("gruppen", []):
                        gruppe = Gruppe(
                            name=gruppe_data["name"], vorlage_id=neue_vorlage.id
                        )
...
def setup_database(app_instance):
    ...
    with app_instance.app_context():
        ...
        # Fülle die Datenbank mit den Standard-Vorlagen
        print("Prüfe auf Standard-Vorlagen...")
